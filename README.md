...
- Последние 3 года занимаюсь аналитикой данных, аналитическим прогнозированием. Владею необходимым стеком для полного цикла анализа данных (SQL, Python, A/B-тесты, Airflow, BI).  
- В работе для меня главное - точность, аналитический подход и умение находить решения.  
- Ищу команду, в которой смогу применять свои навыки для решения бизнес-задач и оказания прямого влияния на продукт.  
- В свободное время занимаюсь разведением комнатных растений, которые помогают мне оживить интерьер и создать в доме особую атмосферу.  
...
<details>	   
  ...
  «БАЗА. Основы визуализации данных в Excel» (Stepik). [Сертификат можно посмотреть тут](https://stepik.org/cert/3096199) <br>
