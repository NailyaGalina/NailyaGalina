...
- Имею опыт работы с анализом данных в сфере энергоэффективности предприятия. Владею необходимым стеком для полного цикла анализа данных (SQL, Python, A/B-тесты, Airflow, BI).  
