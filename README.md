...
- Имею опыт работы с анализом данных в сфере энергоэффективности предприятия. В работе для меня главное - точность, аналитический подход и умение находить решения.  
- Ищу команду, в которой смогу применять свои навыки для решения бизнес-задач.
